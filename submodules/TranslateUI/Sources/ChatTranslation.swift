...
public func translateMessageIds(context: AccountContext, messageIds: [EngineMessage.Id], toLang: String, viaText: Bool = false, forQuickTranslate: Bool = false) -> Signal<Never, NoError> {
