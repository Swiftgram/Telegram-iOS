    ...
    public static func with(appConfiguration: AppConfiguration) -> PremiumConfiguration {
        ...
        if let data = appConfiguration.data {
            ...
            return PremiumConfiguration(
                ...
                showPremiumGiftInAttachMenu: false, // data["premium_gift_attach_menu_icon"] as? Bool ?? defaultValue.showPremiumGiftInAttachMenu, /* MARK: Swiftgram */
                showPremiumGiftInTextField: false, // data["premium_gift_text_field_icon"] as? Bool ?? defaultValue.showPremiumGiftInTextField, /* MARK: Swiftgram */
                giveawayGiftsPurchaseAvailable: false, // data["giveaway_gifts_purchase_available"] as? Bool ?? defaultValue.giveawayGiftsPurchaseAvailable, /* MARK: Swiftgram */
                starsGiftsPurchaseAvailable: false, // data["stars_gifts_enabled"] as? Bool ?? defaultValue.starsGiftsPurchaseAvailable, /* MARK: Swiftgram */
